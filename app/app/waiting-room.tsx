...
const makeStyles = (theme: any) => StyleSheet.create({
    ...
    backBtn: { width: 60 },
    backText: { color: theme.danger, fontSize: 15, },
    topBarTitle: { fontSize: 17, color: theme.text },
    ...
    idLabel: { fontSize: 11, color: theme.textSecondary, letterSpacing: 2, marginBottom: 8 },
    idValue: { fontSize: 28, color: theme.accent, letterSpacing: 4, textAlign: 'center' },
    ...
    statusTitle: { fontSize: 22, color: theme.text, textAlign: 'center', marginBottom: 8 },
    ...
    playerLabel: { color: theme.textSecondary, fontSize: 12, letterSpacing: 1 },
    depositBadge: { fontSize: 11, },
    vs: { fontSize: 18, color: theme.accent },
    ...
    stakeLabel: { fontSize: 11, color: theme.textSecondary, letterSpacing: 2, marginBottom: 4 },
    stakeValue: { fontSize: 28, color: '#14F195', marginBottom: 4 },
    ...
    depositBtnText: { color: '#000', fontSize: 16, letterSpacing: 1 },
    ...
    warningText: { color: '#FFAA00', fontSize: 12, textAlign: 'center' },
    ...
    startBtnText: { color: '#fff', fontSize: 16, letterSpacing: 1.5 },
    ...
    logTitle: { fontSize: 11, color: theme.textSecondary, letterSpacing: 2, marginBottom: 10 },
